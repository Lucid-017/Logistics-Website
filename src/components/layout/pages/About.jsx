...
const About = ({img,heading,details}) => {
  return (
    <div>
      ...
      <div className="">
        <div className="py-20 grid grid-cols-2 gap-5 px-40">
          <div className="text">
        ...
        <div className="py-20 px-40 grid grid-cols-2 gap-5 mb-10 bg-ash-500">
          <div className="text">
        ...
        <div className="2divs px-40 my-20 mb-40">
