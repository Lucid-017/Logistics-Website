...
const Footer = () => {
  ...
  return (
    <footer className='grid md:grid-cols-4 lg:grid-cols-4 text-center md:text-center lg:text-start justify-center gap-10 p-20 bg-black text-white '>
      ...
      <div className='shift-left grid'>
          <a href='#' className='mb-2'>About Us</a>
          <a href='#'  className='mb-2'>Contact</a>
          <a href='#' >Privacy Policy</a>
      </div>
      <div className='shift-left grid'>
          <a href='#' className='mb-2'>Track order</a>
          <a href='#'  className='mb-2'>Request Pickup</a>
          <a href='#'  className='mb-2'>Terms & conditions</a>
      
      </div>
      <div>
        <p>&copy; Dammy Faruq Global Limited.All Rights Reserved {getYear}</p>
      </div>
